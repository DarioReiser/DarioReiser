...
- **Bootstrap 5 From Scratch | Build 5 Modern Websites**  
  ...
  ✅ Completed all projects and built 5 modern websites from scratch.

- **Crash Course: Build a Full-Stack Web App in a Weekend!**  
  Instructor: Jonas Schmedtmann  
  ✅ Built a full-stack web app from the ground up in a weekend, following the complete project.

- **The Git & Github Bootcamp**  
  Instructor: Colt Steele  
  ✅ Mastered Git version control and GitHub collaboration workflows, and completed all hands-on exercises.

- **Complete Web & Mobile Designer: UI/UX, Figma, +more**  
  Instructors: Andrei Neagoie, Daniel Schifano  
  ✅ Designed UI/UX projects and worked with Figma to create polished, mobile-responsive designs.

- **The Modern Flexbox, Grid, Sass & Animations Developer Course**  
  Instructor: Muslim Helalee  
  ✅ Learned advanced CSS techniques including Flexbox, Grid, Sass, and animations through project-based learning.

- **Emmet in Visual Studio Code: Accelerate your HTML workflow**  
  Instructor: Sergey Shtyrlov  
  ✅ Mastered Emmet to speed up HTML and CSS workflows for faster development.

- **The Complete CSS Flexbox Guide With a Complete Project 2024**  
  Instructor: Ahmed Sadek  
  ✅ Built real-world CSS Flexbox layouts with a complete project, refining responsive design skills.

- **Creative Advanced CSS & JavaScript Animations - 150 Projects**  
  Instructor: Ahmed Sadek  
  ✅ Created 150 advanced CSS and JavaScript animations to build visually appealing, interactive websites.

- **Demystifying Parallax: Learn to Create Interactive Web Pages**  
  Instructor: Rich Armstrong  
  ✅ Implemented parallax scrolling effects and interactive web pages through detailed exercises.

- **SQL for Beginners: Learn SQL using MySQL and Database Design**  
  Instructors: Tim Buchalka's Learn Programming Academy, Tim Buchalka, Jean-Paul Roberts  
  ✅ Mastered SQL basics and database design concepts through practical projects.

- **The Ultimate MySQL Bootcamp: Go from SQL Beginner to Expert**  
  Instructor: Colt Steele  
  ✅ Learned advanced SQL techniques, from querying databases to complex operations, through expert-level projects.

- **Advanced CSS and Sass: Flexbox, Grid, Animations and More!**  
  Instructor: Jonas Schmedtmann  
  ✅ Completed advanced CSS and Sass concepts, including Flexbox, Grid, and complex animations with practical projects.

- **Level Up Your CSS Animation Skills**  
  Instructor: Donovan Hutchinson  
  ✅ Enhanced CSS animation skills by creating engaging, smooth animations for websites.

- **The Complete JavaScript Course 2025: From Zero to Expert!**  
  Instructor: Jonas Schmedtmann  
  ✅ Built complex JavaScript applications and mastered advanced JavaScript topics for modern web development.

- **Web Design for Web Developers: Build Beautiful Websites!**  
  Instructor: Jonas Schmedtmann  
  ✅ Designed and developed beautiful, user-friendly websites for different platforms using responsive design techniques.

- **Build Responsive Real-World Websites with HTML and CSS**  
  Instructor: Jonas Schmedtmann  
  ✅ Created fully responsive, real-world websites using HTML and CSS, mastering layout principles and techniques.

---

✅ I have not only completed these courses but also worked on the projects associated with them to ensure hands-on experience and mastery of each subject.  
